...
<br>
<h3 style="font-weight: bold">Criar Quadrado</h3><hr>
    ...
    <div class="margin-top">
        ...
        <?php
            ...
            if($busca == 1){
                ...
                $consulta = $pdo->query("SELECT * FROM quadrado 
                                        WHERE tabuleiro_idTabuleiro LIKE '$procurar%'
                                        ORDER BY tabuleiro_idTabuleiro");}
        ...
        <tr><td><?php echo $linha['id'];?></td>
            ...
            <td><a href="show.php?id=<?php echo $linha['id']?>&lado=<?php echo $linha['lado']?>&cor=<?php echo $cor?>"><img src="img/visualizador.png" style="width: 1.8vw;"></td></a>
            <!-- <td><a href="show.php"> <img src="img/visualizador.png" style="width: 1.8vw;"></a> -->
            <td><a href='editar.php?acao=editar&id=<?php echo $linha['id'];?>&lado=<?php echo $linha['lado'];?>&cor=<?php echo $cor;?>'> <img src="img/edit.png" style="width: 1.8vw;"></a></td>
            <td><?php echo "<a href=javascript:excluir('acao.php?acao=excluir&id={$linha['id']}')>";?><img src="img/delete.png" style="width: 1.5vw;"></a></td>
        </tr>
